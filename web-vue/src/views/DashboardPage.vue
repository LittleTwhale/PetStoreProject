...
const trendOption = computed(() => {
  ...
  return {
    ...
    grid: { left: 10, right: 10, top: 40, bottom: 45, containLabel: true },
    ...
    <div class="page-body" v-loading="isLoading">
      ...
      <div class="content-row">
        ...
        <div class="card panel-alerts">
          <h4 class="card-title">
            低库存预警
            <el-tag
              v-if="(data?.inventory_alerts?.length || 0) > 0"
              type="danger"
              size="small"
              style="margin-left: 8px"
              >{{ data?.inventory_alerts?.length || 0 }}项</el-tag
            >
          </h4>
      ...
      <div class="content-row">
        <div class="card panel-top">
          <h4 class="card-title">
            <el-icon :size="14"><Goods /></el-icon> 热门商品 Top 5
          </h4>
        ...
        <div class="card panel-top">
          <h4 class="card-title">
            <el-icon :size="14"><Scissor /></el-icon> 热门服务 Top 5
          </h4>
      ...
      <div class="card">
        ...
        <el-table v-else :data="data.recent_orders" size="small" stripe>
          ...
          <el-table-column label="操作" width="80">
            <template #default="">
              <el-button type="primary" link size="small" @click="router.push('/orders')"
                >查看</el-button
              >
            </template>
          </el-table-column>
